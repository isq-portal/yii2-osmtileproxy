...
var osmap_markertext = "Schwendenerstr. 31, 14195 Berlin";
...
/** save script ids to enable more than one map on a page **/
/**
var osmap_script1 = document.currentScript;
var osmap_fullUrl = osmap_script1.src;  

var osmap_root = document.location.hostname;
var osmap_idx1=(" "+osmap_fullUrl).indexOf(osmap_root);

if(osmap_idx1>0) {
    osmap_idx1--;
    osmap_idx1+=osmap_root.length;
    var osmap_idx2=osmap_fullUrl.indexOf("/",osmap_idx1);
    if(osmap_idx2>0) {
        osmap_relpath=osmap_fullUrl.substr(osmap_idx2);
        var osmap_idx3=osmap_relpath.lastIndexOf("/");
        if(osmap_idx3>0) {
            osmap_relpath=osmap_relpath.substr(0,osmap_idx3+1);
        }
    }
}
**/
